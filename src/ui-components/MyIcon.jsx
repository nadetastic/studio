...
export default function MyIcon(props) {
  ...
  const variants = [
    ...
    {
      variantValues: { type: "arrow_drop_down" },
      overrides: {
        MyIcon: {
          paths: [
            {
    ...
    {
      variantValues: { type: "shopping_cart" },
      overrides: {
        MyIcon: {
          paths: [
            {
    ...
    {
      variantValues: { type: "arrow_drop_up" },
      overrides: {
        MyIcon: {
          paths: [
            {
    ...
    {
      variantValues: { type: "check_box_outline_blank" },
      overrides: {
        MyIcon: {
          paths: [
            {
